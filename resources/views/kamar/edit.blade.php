                ...
                <div class="card-body">
                    <form action="{{ route('kamar.update', $kamar->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_kamar') is-invalid @enderror" id="kode_kamar" name="kode_kamar" value="{{ $kamar->kode_kamar }}">
                            @error('kode_kamar')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tipe_kamar') is-invalid @enderror" id="tipe_kamar" name="tipe_kamar">
                                ...
                                <option value="Kelas 1" {{ $kamar->tipe_kamar == 'Kelas 1' ? 'selected' : '' }}>Kelas 1</option>
                                <option value="Kelas 2" {{ $kamar->tipe_kamar == 'Kelas 2' ? 'selected' : '' }}>Kelas 2</option>
                                <option value="Kelas 3" {{ $kamar->tipe_kamar == 'Kelas 3' ? 'selected' : '' }}>Kelas 3</option>
                            </select>
                            @error('tipe_kamar')
                                <div class="invalid-feedback">
                                    {{ $message }}
