        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5" style="border-color: rgba(256, 256, 256, .3) !important;">Welcome To Official Website Upaya Sehat Hospital</h5>
                    <h1 class="display-1 text-white mb-md-4">Solusi Kesehatan Terbaik di Sorong</h1>
                    <div class="pt-2">
                        <a href="/about" class="btn btn-light rounded-pill py-md-3 px-md-5 mx-2">Tentang Kami</a>
                        <a href="/layanan" class="btn btn-outline-light rounded-pill py-md-3 px-md-5 mx-2">Layanan</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="{{ asset('img/dokter42.png') }}" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
            ...
            <div class="row g-5">
                <div class="col-xl-4 col-lg-6">
                    <div class="bg-light rounded overflow-hidden">
                        <img class="img-fluid w-100" src=" {{ asset('img/dokter2.jpeg') }}" alt="">
                        <div class="p-4">
